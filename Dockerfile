...
# ==================
# below sourced from https://gitlab.com/nvidia/opengl/blob/ubuntu16.04/glvnd/runtime/Dockerfile
...
#===============
# below sourced from https://gitlab.com/nvidia/cuda/blob/ubuntu16.04/8.0/devel/Dockerfile
RUN apt-get update && apt-get install -y --no-install-recommends \
